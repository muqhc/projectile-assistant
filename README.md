...
the projectile assistant mod in fabric
...
this project is generated from [myoun/fabric-example-mod-kotlin-with-kotlin-dsl](https://github.com/myoun/fabric-example-mod-kotlin-with-kotlin-dsl)